...
Local CLI quality adapters provide optional WhisperX alignment, subtitle
merging, readability optimization, and final domain validation while
preserving the workflow stage contracts. Local CLI progress
